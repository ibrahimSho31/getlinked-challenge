...
const SectionSeven = () => {
    return(
        ...
        <section className="flex flex-col xl:flex-row montserrat overflow-x-hidden items-center justify-between border-[1px]  xl:px-[100px] pt-[70px] xl:pt-[100px]  border-solid border-[#ffffff2e] border-x-[0px] border-t-[0px]">
                ...
                />
                        <h1 className="clashDisplayBig text-[32px]">Prizes and <br /> <span className="text-[#D434FE]">Rewards</span></h1>
                        <p className="text-[16px] font-[400]">Highlight of the prizes or rewards for winners <br /> and for participants.</p>
                    </div>
                    <img 
                        src={trophy}
                    />
                ...
                />
                    <div className="xl:text-left hidden xl:flex text-center flex-col">
                        <h1 className="clashDisplayBig text-[32px]">Prizes and <br /> <span className="text-[#D434FE]">Rewards</span></h1>
                        <p className="text-[16px] font-[400]">Highlight of the prizes or rewards for winners <br /> and for participants.</p>
                    </div>
                    <img 
                ...
                />
                    ...
                    <div className="flex w-[200px] flex-row pt-[100px] xl:pt-[260px] items-center justify-center">

                    <div className="bg-[#D434FE1F] px-[20px]  mt-[40px] xl:mt-[-200px]  rounded-[8px] w-[90px] xl:w-[212px] flex flex-col items-center justify-center
                     h-[125px] xl:h-[290px] border-[1px] border-solid border-[#D434FE]">
                        ...
                        />
                        <h1 className="text-[12px] xl:text-[36px] font-[900]">
                            2nd 
                        </h1>
                        <p className="text-[12px] xl:text-[24px] font-[600]">Runner</p>
                        <h2 className="text-[14px] xl:text-[32px] text-[#D434FE] font-[900]">N300,000</h2>
                    </div>
                    ...
                    <img 
                        ...
                        />
                    <div className="bg-[#903AFF1F] relative top-[-60px] xl:top-[-300px] rounded-[8px] w-[90px] xl:w-[212px] flex flex-col items-center justify-center
                     h-[147px] xl:h-[320px] border-[1px] border-solid border-[#903AFF] mx-[10px] xl:mx-[30px]  ">
                        <h1 className="text-[12px] xl:text-[36px] font-[900] ">
                            1st 
                        </h1>
                        <p className="text-[12px] xl:text-[24px] font-[600]">Runner</p>
                        <h2 className="text-[14px] xl:text-[32px] text-[#D434FE] font-[900]">N400,000</h2>
                        </div>
                    ...
                    <div className="bg-[#D434FE1F] px-[20px]  rounded-[8px] w-[90px] xl:w-[212px] 
                    flex flex-col items-center justify-center mt-[40px] xl:mt-[-200px]
                     h-[125px] xl:h-[290px] border-[1px] border-solid border-[#D434FE]">
                        ...
                        <p className="text-[12px] xl:text-[24px] font-[600]">Runner</p>
                        <h2 className="text-[14px] xl:text-[32px] text-[#D434FE] font-[900]">N150,000</h2>
                    </div>
