import { lock, manOnLock, check, GreyStar, darkPurpleStar, Star, purpleStar } from "./assets"
...
const SectionNine = () => {
    ...
    const policies = [
        {
            id: 1,
            policy: "The Standard License grants you a non-exclusive right to navigate and register for our event"
        },
        {
            id: 2,
            policy: "You are licensed to use the item available at any free source sites, for your project developement"
        }
    ]

    return(
        <section className="border-[1px] border-solid border-[#ffffff2e] border-x-[0px] border-t-[0px]
        ...
        ">
            ...
            <img 
                ...
                Privacy Policy and <br /> <span className="text-[#D434FE]"> Terms</span>
                </h1>
                ...
                <section className="bg-[#D9D9D908] w-full xl:w-[569px] p-[20px] xl:p-[50px] rounded-[5px]
                 border-solid border-[1px] border-[#D434FE] flex flex-col ">
                    <p className="text-[12px] xl:text-[14px] leading-[30px]">At getlinked tech Hackathon 1.0, we value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you participate in our tech hackathon event. By participating in our event, you consent to the practices described in this policy.</p>

                    <h1 className="pt-[30px] pb-[15px] text-[#D434FE] text-[16px] font-[700] text-left">Licensing Policy</h1>
                    <h2 className="text-[12px] xl:text-[14px] pb-[20px] text-left">Here are terms of our Standard License:</h2>


                    {
                        policies.map((policy, id) => (
                            <div key={id} className="flex flex-row items-start pb-[20px] text-left">
                                <img 
                                    src={check}
                    ...
                    <button className="headerBtn self-center w-[122px] 
