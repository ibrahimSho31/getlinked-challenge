...
import { Man, topPurple, thinker, smallMark, bigMark, plus, darkPurpleStar, purpleStar, GreyStar, Star } from "./assets"
...
const SectionFive = () => {
    ...
    return (
        <>
                      <section className="flex flex-col xl:flex-row items-center z-[50] justify-between 
              xl:px-[0px] pt-[100px] pb-[30px]  overflow-x-hidden
  ...
  >
        ...
        />
            ...
            <div
            className="z-[50] xl:px-[150px] mb-[100px] xl:mb-[0px]"
            >
            <img 
                src={darkPurpleStar}
                className="ml-[-30px] pb-[20px] blinking"
            />
                ...
                We got answers to the questions that you might <br /> want to ask about <span className="font-[700]"> getlinked Hackathon 1.0</span> 
                </p>

                {
                    questions.map((question, id) => (
                        <div key={id}>
                            ...
                            <p className="montserrat text-[14px] text-left">{question.question}</p>
                            <img 
                                src={plus}
                            ...
                            <hr 
                                className="bg-[#D434FE] w-full h-[2px] border-none mb-[30px]"
                            />
                        </div>
                    ))
                }
