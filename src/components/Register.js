    ...
    <>
      ...
      >
        <section className=" flex flex-col text-[16px] font-[400]">
          <h1 className="text-[#D434FE] text-[20px]  ml-[-60px] font-[600] block xl:hidden ">
            Register
          </h1>
          <img
            src={purpleStar}
        ...
        <section className="flex flex-col">
          ...
          <section className="xl:bg-[#1c152e]  z-40 pb-[50px] flex flex-col w-full rounded-[12px] xl:w-[617px] px-[20px] xl:p-[50px]">
            <form onSubmit={handleApplication}>
              <h1 className="text-[#D434FE] text-[20px] font-[600] hidden xl:block">
                Register
              </h1>
              ...
              <div className="flex flex-col xl:flex-row w-full justify-between">
                <div className="w-full xl:w-[47%]">
                  <h1 className="text-[13px] xl:text-[14px] pb-[3px]">Team's Name</h1>
                  <input
                ...
                <div className="w-full xl:w-[47%] xl:my-[0px] my-[10px]">
                  <h1 className="text-[13px] xl:text-[14px] pb-[3px]">Phone</h1>
                  <input
              ...
              <div className="flex flex-col xl:flex-row w-full justify-between xl:my-[30px]">
                <div className="w-full xl:w-[47%]">
                  <h1 className="text-[13px] xl:text-[14px] pb-[3px]">Email</h1>
                  <input
                ...
                <div className="w-full xl:w-[47%] xl:my-[0px] my-[10px]">
                  <h1 className="text-[13px] xl:text-[14px] pb-[3px]">Project Topic</h1>
                  <input
              ...
              <div className="flex flex-row w-full justify-between">
                <div className="w-[67%] xl:w-[47%]">
                  <h1 className="text-[13px] xl:text-[14px] pb-[3px]">Category</h1>
                ...
                <div className="w-[30%] xl:w-[47%]">
                  <h1 className="text-[13px] xl:text-[14px] pb-[3px]">Group Size</h1>
                  <select
                    className="h-[47px] bg-[#FFFFFF08] text-[12px] rounded-[4px] border-[1px] border-[solid] border-[#FFFFFF] xl:bg-transparent w-full px-[20px]"
              ...
              {
                  errorMessage !== '' && <p className="text-[12px] text-[red] pb-[20px] ">{errorMessage}</p>
                }
