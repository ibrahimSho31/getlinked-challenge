              ...
              <section className="flex flex-col">
                ...
                <section className="xl:bg-[#1c152e] z-40 flex flex-col w-full rounded-[12px] xl:w-[617px] px-[50px] xl:p-[50px]">
                  <form onSubmit={handleContactUs}>
                    ...
                    {errorMessage !== "" && (
                      <p className="text-[12px] text-[red] pt-[20px] ">
                        {errorMessage}
                      </p>
                    )}
                ...
                <form onSubmit={handleContactUs}>
                  ...
                  <div className="flex flex-col ">
                    ...
                    <input
                      ...
                      placeholder="Mail"
                      type="email"
                      className="h-[47px] my-[20px] rounded-[4px] border-[1px] border-[solid] border-[#FFFFFF] bg-transparent px-[20px]"
                      required
                    />
                  ...
                  {successMessage !== "" && (
                    <p className="text-[12px] text-green-400 pt-[20px] ">
                      {successMessage}
                    </p>
                  )}
                  <div className="flex flex-row items-center justify-center pt-[20px] xl:pt-[50px]">
